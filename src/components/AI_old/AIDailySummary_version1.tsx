...
export default function AIDailySummary({
  ...
  const generateDailySummary = async () => {
    if (!aiSession) {
      alert('AI Session not available. Please check Chrome flags.')
      return
    }
...
`
      ...
      const summary = await aiSession.prompt(summaryData)
    ...
    <div>
      ...
      <div className="space-y-6 mt-4">
        ...
        <button
          ...
          disabled={isSummarizing || !aiSession || todayTasks.length === 0}
